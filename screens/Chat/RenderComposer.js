...
const InputOnKeyboard = ({
  ...
  const [bottomSafeArea, setBottomSafeArea] = useState(
    handleInternally ? BottomSafeAreaHeight : 0
  );
    ...
    >
      ...
      >
        <TextInput
          ...
          onBlur={() =>
            setBottomSafeArea(handleInternally ? BottomSafeAreaHeight : 0)
          }
